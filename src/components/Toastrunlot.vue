  ...
  <div class="toast toastrunlot" v-if="isShowToast">
    ...
    <div class="wordp haslot ab" v-if="toastType == 2">
      ...
      <div v-if="actInfo.nowprize_name.indexOf('券') == -1" class="ab shiti-p">
        <img
          v-if="actInfo.nowprize_name.indexOf('手机') != -1"
          class="prizeimg"
          src="//activity-codoon.b0.upaiyun.com/playover/upload/p_icon_phone.png"
        />
        <img
          v-if="actInfo.nowprize_name.indexOf('VR') != -1"
          class="prizeimg"
          src="//activity-codoon.b0.upaiyun.com/playover/upload/p_icon_vr.png"
        />
        <img
          v-if="actInfo.nowprize_name.indexOf('耳机') != -1"
          class="prizeimg"
          src="//activity-codoon.b0.upaiyun.com/playover/upload/p_icon_erji.png"
        />
        <img
          v-if="actInfo.nowprize_name.indexOf('电影周边') != -1"
          class="prizeimg"
          src="//activity-codoon.b0.upaiyun.com/playover/upload/p_icon_movie.png"
        />
        <img
          v-if="actInfo.nowprize_name.indexOf('运动装备') != -1"
          class="prizeimg"
          src="//activity-codoon.b0.upaiyun.com/playover/upload/p_icon_sport.png"
        />
